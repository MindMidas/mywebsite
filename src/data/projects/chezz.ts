...
export const chezz: ProjectInfo = {
  ...
  details: [
    ...
    { label: "Result", text: "Incredibly faster than the Python version and smarter because the engine is not only searching deeper, it is using heuristics I spent time tuning. It still has room to improve, but I'm proud of what I built. I also turned it into a server-backed online game where you can play against the engine or against other players." },
  ],
